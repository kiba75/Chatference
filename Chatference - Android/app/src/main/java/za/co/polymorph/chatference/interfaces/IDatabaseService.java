...
public interface IDatabaseService {
    ...
    void postComment(String roomUuid, String comment, PostCommentCallback postCommentCallback);
    void getComments(String roomUuid, GetCommentsCallback getCommentsCallback);
    void cancelGettingComments();
